    ...
    <div className='container relative flex-col items-center justify-center h-screen w-screen mb-12 overflow-hidden'>
      ...
      <div className='absolute w-full item-center mt-16 m-3 z-30 p-9 text-2xl rounded-xl'>
        ...
        <div className=' ml-48 items-center  sm:mt-8 sm:flex justify-center '>
          <a
            href='/mainsurvey'
            className='font-noto w-auto font-bold flex items-center justify-center px-8 py-3 border border-transparent  rounded-md text-white bg-custom-main hover:bg-custom-main-hover md:py-4 md:text-lg md:px-10'
          >
            나와 맞는 도시 찾기!
          </a>
        </div>
