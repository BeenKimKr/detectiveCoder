      ...
      <div className='absolute item-center m-3 z-30 p-5 text-2xl rounded-xl'>
        <main className=' lg:px-8 mx-auto max-w-7xl px-4 sm:mt-0 sm:px-6 md:mt-0 lg:mt-0 lg:px-8'>
          <div className='sm:text-center lg:text-left'>
            ...
            <p className=' font-irop mt-3 object-cover text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:text-center'>
            ...
            <div className='mt-5 sm:mt-8 sm:flex justify-center'>
              <div className='rounded-md shadow items-center'>
                <a
                  href='/mainsurvey'
                  className='font-noto font-bold flex items-center justify-center px-8 py-3 border border-transparent font-medium rounded-md text-white bg-custom-main hover:bg-custom-main-hover md:py-4 md:text-lg md:px-10'
                >
                  나와 맞는 도시 찾기!
                </a>
              </div>
